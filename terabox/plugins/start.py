    ...
    if len(message.command) > 1:
        ...
        if referred_by.isdigit(): 
            ...
            if referrer_data:
                ...
                if referrer_data["referrals"] >= 5:
                    ...
                    await client.send_message(
                        int(referred_by),
                        "Congratulations! You referred 5 users and earned 24hours of free premium access! click below button to buy premium and get contents on telegram",
            ...
            await message.reply_text(
                "Added 24hours of usage token! subscribe to premium on just 50 rs for more features.",
                reply_markup=InlineKeyboardMarkup([
                            [InlineKeyboardButton("Subscribe to premium", callback_data="buy_premium")]
                        ])
            )
